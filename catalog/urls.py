...
from catalog.views import ProductListView, ProductDetailView, CategoryDetailView, without_category, product_unpublish, \
    product_publish
...
urlpatterns = [
    ...
    path('product/<int:pk>/publish', product_publish, name="product_publish"),
    path('product/<int:pk>/unpublish', product_unpublish, name="product_unpublish"),
